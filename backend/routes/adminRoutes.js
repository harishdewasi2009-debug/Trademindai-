...
router.get('/scanner-accuracy/calendar', ctrl.getScannerAccuracyCalendarView);
router.get('/scanner-accuracy/coverage', ctrl.getScannerCoverageStatus);
router.post('/scanner-accuracy/scan-now', ctrl.runScannerCoverageBatchNow);
